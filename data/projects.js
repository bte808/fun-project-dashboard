window.FUN_PROJECT_DASHBOARD_DATA = {
  "meta": {
    ...
    "generatedAt": "2026-06-05T11:33:03.661Z",
    ...
    "highlights": [
      ...
      },
      {
        ...
        "reason": "外部 OSS PR 已从 draft 改为 ready for review：修复 gh run view --job 输出应 passthrough 的回归；当前 mergeable，CLA 待签，上游 CI 等待维护者批准运行。",
        "status": "needs-action",
        "kind": "external-pr"
      },
      {
      ...
      {
        "name": "fun-project-dashboard v0.2.5",
        "url": "https://github.com/bte808/fun-project-dashboard/releases/tag/v0.2.5",
        "reason": "发布 CI action maintenance；Dashboard CI 升级到 actions/checkout@v6 和 actions/setup-node@v6，并保持 release evidence alignment 与 DOM smoke 通过。",
        "status": "release",
        "kind": "own-release"
      },
      {
        ...
        "reason": "同步 GitHub profile 门面：RTK PR 已从 draft 改为 ready for review，Cloudberry PR 已归入 merged，QGIS duplicate PR 已从 review 列表移除，最新 release 指向 Maintainer Signal Board v0.7.3 与 Fun Project Dashboard v0.2.5。",
        "status": "profile",
        "kind": "profile"
      },
      {
  ...
  "projects": [
    {
      "name": "fun-20260604-a-star-sling",
      "url": "https://github.com/bte808/fun-20260604-a-star-sling",
      "description": "A tiny no-dependency daily canvas game about slinging a star core through a constellation field.",
      "defaultBranch": "main",
      "createdAt": "2026-06-04T02:56:19Z",
      "updatedAt": "2026-06-04T19:51:58Z",
      "createdDateShanghai": "2026-06-04",
      "updatedDateShanghai": "2026-06-05",
      ...
      "readme": {
        "oneLine": "A tiny no-dependency daily canvas game about slinging a star core through a constellation field.",
        "usefulness": "It is a low-friction browser toy for a quick break, a daily challenge, or a shareable score post. The whole project is small enough to read, fork, and remix without installing a framework.",
        "whyFun": "The field is immediately readable: gold stars are rewards, red fields are danger, the teal ring is the dock. Every sling leaves a trail, so a missed shot gives useful feedback instead of feeling random.",
        "runCommand": "npm run serve",
        "verification": "Local checks cover: Required files and README sections. Deterministic daily field generation. A planned solver that completes the daily field with all stars and zero heat. Bad-shot behavior that cannot outscore a clean..."
      },
      "today": {
        "created": false,
        "updated": true,
    ...
    },
    {
      "name": "fun-20260604-b-safe-payout-card",
      "url": "https://github.com/bte808/fun-20260604-b-safe-payout-card",
      "description": "Local-first safe payout calculator for indie makers and small operators.",
      "defaultBranch": "main",
      "createdAt": "2026-06-04T02:37:44Z",
      "updatedAt": "2026-06-04T19:46:44Z",
      "createdDateShanghai": "2026-06-04",
      "updatedDateShanghai": "2026-06-05",
      "primaryLanguage": "JavaScript",
      "languages": {
      ...
      "readme": {
        "oneLine": "Local-first safe payout calculator for indie makers and small operators.",
        "usefulness": "Small businesses and indie projects often decide owner draws with scattered notes: a Stripe balance here, a tax guess there, an invoice list in chat. This app puts the reserve floor in one visible card so the payout dec...",
        "whyFun": "待补充",
        "runCommand": "npm run serve",
        "verification": "The browser verification opens the static site in headless Chrome, tests the main calculation path, captures desktop/mobile screenshots, and checks for mobile overflow at 390x844."
      },
      "today": {
        "created": false,
        "updated": true,
    ...
    {
      "name": "fun-20260604-c-construct-canvas",
      "url": "https://github.com/bte808/fun-20260604-c-construct-canvas",
      "description": "Local-first construct and operational-definition canvas for research-methods planning.",
      "defaultBranch": "main",
      "createdAt": "2026-06-04T02:33:02Z",
      "updatedAt": "2026-06-04T02:33:16Z",
      "createdDateShanghai": "2026-06-04",
      "updatedDateShanghai": "2026-06-04",
      "primaryLanguage": "JavaScript",
      "languages": {
        "JavaScript": 31365,
        "CSS": 6415,
      ...
      "readme": {
        "oneLine": "Local-first construct and operational-definition canvas for research-methods planning.",
        "usefulness": "Many early research ideas fail because the construct, variable role, measurement rule, and sample boundary are mixed together in prose. This tool keeps those pieces separate on one screen, so a learner can quickly see w...",
        "whyFun": "待补充",
        "runCommand": "python3 -m http.server 5254 --bind 127.0.0.1",
        "verification": "待补充"
      },
      "today": {
        "created": false,
    ...
    },
    {
      ...
      "updatedAt": "2026-06-04T02:46:23Z",
      "createdDateShanghai": "2026-06-03",
      "updatedDateShanghai": "2026-06-04",
      "primaryLanguage": "JavaScript",
      "languages": {
    ...
    },
    {
      ...
      "updatedAt": "2026-06-04T02:50:35Z",
      ...
      "readme": {
        ...
        "verification": "The browser verifier launches local Chrome in headless mode, opens the static page, checks the sample render, simulates custom input, verifies Markdown preview output, captures the README screenshot, and repeats layout..."
      },
      "today": {
        "created": false,
        "updated": false,
    ...
    },
    {
      ...
      "updatedAt": "2026-06-03T14:14:01Z",
      "createdDateShanghai": "2026-05-31",
      "updatedDateShanghai": "2026-06-03",
      "primaryLanguage": "JavaScript",
      "languages": {
      ...
      "readme": {
        ...
        "whyFun": "待补充",
        "runCommand": "待补充",
        "verification": "Local checks: npm test runs calculation tests and static wiring checks. npm run verify:browser starts a local server, opens temporary headless Chrome sessions, edits the tool at desktop and 390 x 844 mobile sizes, check..."
      },
      "today": {
        "created": false,
        "updated": false,
    ...
    },
    {
      ...
      "updatedAt": "2026-06-04T02:51:45Z",
      "createdDateShanghai": "2026-05-31",
      "updatedDateShanghai": "2026-06-04",
      "primaryLanguage": "JavaScript",
      "languages": {
      ...
      "readme": {
        "oneLine": "Tiny no-dependency browser rhythm game: catch colorful rave pulses before the relay drops.",
        "usefulness": "A full run is 18 pulses, so one attempt takes less than a minute. The daily setlist is deterministic, which makes scores easy to compare. Timing grades, combo bonuses, a hype meter, local best score, and copyable result...",
        "whyFun": "A full run is 18 pulses, so one attempt takes less than a minute. The daily setlist is deterministic, which makes scores easy to compare. Timing grades, combo bonuses, a hype meter, local best score, and copyable result...",
        "runCommand": "python3 -m http.server 5212",
        "verification": "待补充"
      },
      "today": {
        "created": false,
    ...
    },
    {
      ...
      "updatedAt": "2026-06-04T02:51:22Z",
      "createdDateShanghai": "2026-05-31",
      "updatedDateShanghai": "2026-06-04",
      "primaryLanguage": "JavaScript",
      "languages": {
      ...
      "readme": {
        ...
        "whyFun": "待补充",
        "runCommand": "npm run serve",
        "verification": "This repo includes a lightweight Node smoke test: It checks the parser, output formats, static file wiring, mobile CSS breakpoint presence, README/license presence, and that no runtime dependencies were added. With a lo..."
      },
      "today": {
        "created": false,
        "updated": false,
    ...
    },
    {
      ...
      "readme": {
        ...
        "verification": "The smoke test verifies deck generation, scoring, summaries, share text, required static files, and the browser verification hook."
      },
      "today": {
        "created": false,
        "updated": false,
    ...
    },
    {
      ...
      "updatedAt": "2026-06-03T15:21:18Z",
    ...
    },
    {
      ...
      "description": "Local-first VS Code extension risk-card generator with install checklist and next review move.",
      "defaultBranch": "main",
      "createdAt": "2026-05-30T02:31:46Z",
      "updatedAt": "2026-06-04T02:48:06Z",
      "createdDateShanghai": "2026-05-30",
      "updatedDateShanghai": "2026-06-04",
      "primaryLanguage": "JavaScript",
      "languages": {
      ...
      "readme": {
        "oneLine": "Local-first VS Code extension risk-card generator with install checklist and next review move.",
    ...
    },
    {
      ...
      "updatedAt": "2026-06-03T15:24:06Z",
      "createdDateShanghai": "2026-05-30",
      "updatedDateShanghai": "2026-06-03",
      "primaryLanguage": "JavaScript",
      "languages": {
      ...
      "readme": {
        ...
        "runCommand": "npm start",
        "verification": "The smoke test verifies the Shanghai date helper, deterministic daily deck generation, card action rules, scoring, focus damage, perfect-run completion, share text, and required static files."
      },
      "today": {
        "created": false,
        "updated": false,
    ...
    },
    {
      ...
      "readme": {
        ...
        "verification": "The app should load without a blank screen, parse the default sample, render the matrix, support theme filtering, and export Markdown/CSV without requiring a private environment."
      },
      "today": {
        "created": false,
        "updated": false,
    ...
    },
    {
      ...
      "updatedAt": "2026-06-04T02:53:40Z",
      "createdDateShanghai": "2026-05-29",
      "updatedDateShanghai": "2026-06-04",
      "primaryLanguage": "JavaScript",
      "languages": {
      ...
      "readme": {
        ...
        "runCommand": "npm start",
        "verification": "The smoke test verifies the Asia/Shanghai date helper, every level's two-slot solvability, core actions, failure handling, scoring, challenge links, and share text."
      },
      "today": {
        "created": false,
        "updated": false,
    ...
    },
    {
      ...
      "readme": {
        ...
        "verification": "The app has no runtime dependencies. Tests use Node's built-in test runner."
      },
      "today": {
        "created": false,
        "updated": false,
    ...
    },
    {
      ...
      "readme": {
        ...
        "runCommand": "npm start",
        "verification": "The smoke test verifies deterministic daily rounds, custom seed normalization, the Asia/Shanghai date helper, correct and wrong input handling, beam timeout behavior, a finishable perfect run, and share text."
      },
      "today": {
        "created": false,
        "updated": false,
    ...
    },
    {
      ...
      "updatedAt": "2026-06-03T15:34:16Z",
      ...
      "readme": {
        ...
        "whyFun": "The player is always moving, so each choice is tiny and urgent: jump now, wait half a beat, or risk clipping a crater to keep a combo alive. The whole run fits in under a minute, but the daily seed, route preview, share...",
        "runCommand": "npm start",
        "verification": "The smoke test verifies deterministic daily stage generation, route summary text, the Asia/Shanghai date helper, jump controls, hazard resolution, a finishable skilled Breezy run, and challenge share text."
      },
      "today": {
        "created": false,
        "updated": false,
    ...
    },
    {
      ...
      "readme": {
        ...
        "verification": "The validation covers parsing, missing prerequisites, cycle detection, route generation, and a static check for required files, mobile CSS, README caveats, and sample output quality."
      },
      "today": {
        "created": false,
        "updated": false,
    ...
    },
    {
      ...
      "updatedAt": "2026-06-04T02:46:29Z",
      "createdDateShanghai": "2026-05-26",
      "updatedDateShanghai": "2026-06-04",
      "primaryLanguage": "JavaScript",
      "languages": {
    ...
    },
    {
      ...
      "readme": {
        ...
        "verification": "npm test checks deterministic generation, one odd tile per board, scoring, and result text. npm run check checks required files, static app wiring, and the high-contrast control. Local browser verification covered a des..."
      },
      "today": {
        "created": false,
        "updated": false,
    ...
    },
    {
      ...
      "updatedAt": "2026-06-04T02:45:53Z",
      "createdDateShanghai": "2026-05-25",
      "updatedDateShanghai": "2026-06-04",
      "primaryLanguage": "JavaScript",
      "languages": {
      ...
      "readme": {
        ...
        "verification": "The app is dependency-free. The tests use Node's built-in test runner."
      },
      "today": {
        "created": false,
        "updated": false,
    ...
    },
    {
      ...
      "readme": {
        ...
        "whyFun": "待补充",
        "runCommand": "npm start",
        "verification": "The check runs syntax validation for the browser modules and a Node smoke test for claim parsing, evidence linking, status counts, and Markdown export."
      },
      "today": {
        "created": false,
        "updated": false,
    ...
    },
    {
      ...
      "updatedAt": "2026-06-03T15:25:46Z",
      "createdDateShanghai": "2026-05-23",
      "updatedDateShanghai": "2026-06-03",
      "primaryLanguage": "JavaScript",
      "languages": {
    ...
    },
    {
      ...
      "updatedAt": "2026-06-04T02:46:33Z",
      "createdDateShanghai": "2026-05-21",
      "updatedDateShanghai": "2026-06-04",
      "primaryLanguage": "JavaScript",
      "languages": {
    ...
    },
    {
      ...
      "readme": {
        ...
        "runCommand": "npm run start",
        "verification": "The browser UI was also checked on desktop and mobile-sized viewports during the 2026-05-21, 2026-05-25, and 2026-05-28 automation runs."
      },
      "today": {
        "created": false,
        "updated": false,
    ...
    },
    {
      ...
      "description": "Replayable daily dice target puzzle with shareable date challenges",
      "defaultBranch": "main",
      "createdAt": "2026-05-20T05:32:30Z",
      "updatedAt": "2026-06-04T02:49:25Z",
      ...
      "readme": {
        "oneLine": "Replayable daily dice target puzzle with shareable date challenges",
    ...
    },
    {
      ...
      "updatedAt": "2026-06-03T15:26:15Z",
    ...
    },
    {
      ...
      "updatedAt": "2026-06-03T15:28:43Z",
    ...
    },
    {
      ...
      "updatedAt": "2026-06-04T02:46:17Z",
