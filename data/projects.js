window.FUN_PROJECT_DASHBOARD_DATA = {
  "meta": {
    ...
    "generatedAt": "2026-06-05T06:39:33.238Z",
    ...
    "highlights": [
      ...
      {
        "name": "fun-project-dashboard v0.2.0",
        "url": "https://github.com/bte808/fun-project-dashboard/releases/tag/v0.2.0",
        "reason": "发布 CI-backed OSS evidence dashboard；包含申请 brief、公开 CI、Pages 状态 badge、MIT license、贡献指南、安全说明与 issue templates。",
        "status": "release",
        "kind": "own-release"
      },
      {
