window.FUN_PROJECT_DASHBOARD_DATA = {
  "meta": {
    ...
    "generatedAt": "2026-06-05T07:15:19.791Z",
    ...
    "highlights": [
      ...
      {
        "name": "fun-project-dashboard v0.2.3",
        "url": "https://github.com/bte808/fun-project-dashboard/releases/tag/v0.2.3",
        "reason": "发布 standalone reviewer packet；新增一页式评审检查清单，并用 CI 检查 README、live panel、brief、evidence 与 generated data 的 release 链接保持一致。",
        "status": "release",
        "kind": "own-release"
      },
      {
